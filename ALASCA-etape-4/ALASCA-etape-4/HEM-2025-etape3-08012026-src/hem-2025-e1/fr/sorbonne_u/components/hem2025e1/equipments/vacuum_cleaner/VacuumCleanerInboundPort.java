...
public class VacuumCleanerInboundPort
	...
	public VacuumCleanerInboundPort(ComponentI owner) throws Exception {
		...
		assert owner instanceof VacuumCleanerImplementationI : new PreconditionException(
	...
	public void turnOn() throws Exception {
		this.getOwner().handleRequest(
				o -> {
					((VacuumCleanerImplementationI) o).turnOn();
					return null;
				});
	}
	...
	public void turnOff() throws Exception {
		this.getOwner().handleRequest(
				o -> {
					((VacuumCleanerImplementationI) o).turnOff();
					return null;
				});
	}
	...
	public void setHigh() throws Exception {
		this.getOwner().handleRequest(
				o -> {
					((VacuumCleanerImplementationI) o).setHigh();
					return null;
				});
	}
	...
	public void setLow() throws Exception {
		this.getOwner().handleRequest(
				o -> {
					((VacuumCleanerImplementationI) o).setLow();
					return null;
				});
	}
}
