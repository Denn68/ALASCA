...
public class WashingMachineInternalControlInboundPort
	...
	public WashingMachineInternalControlInboundPort(ComponentI owner)
		...
		assert owner instanceof WashingMachineInternalControlI : new PreconditionException(
	...
	public SignalData<Double> getCurrentTemperature() throws Exception {
		return this.getOwner().handleRequest(
				o -> ((WashingMachineInternalControlI) o).getCurrentTemperature());
	}
	...
	public void startHeatingWater() throws Exception {
		this.getOwner().handleRequest(
				o -> {
					((WashingMachineInternalControlI) o).startHeatingWater();
					return null;
				});
	}
	...
	public void stopHeatingWater() throws Exception {
		this.getOwner().handleRequest(
				o -> {
					((WashingMachineInternalControlI) o).stopHeatingWater();
					return null;
				});
	}
}
