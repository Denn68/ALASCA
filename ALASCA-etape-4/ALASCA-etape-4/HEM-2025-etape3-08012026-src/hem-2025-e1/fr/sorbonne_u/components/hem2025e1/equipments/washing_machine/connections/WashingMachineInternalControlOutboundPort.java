...
public class WashingMachineInternalControlOutboundPort
	...
	public SignalData<Double> getTargetTemperature() throws Exception {
		return ((WashingMachineInternalControlCI) this.getConnector()).getTargetTemperature();
	}

	@Override
	public SignalData<Double> getCurrentTemperature() throws Exception {
		return ((WashingMachineInternalControlCI) this.getConnector()).getCurrentTemperature();
	}
