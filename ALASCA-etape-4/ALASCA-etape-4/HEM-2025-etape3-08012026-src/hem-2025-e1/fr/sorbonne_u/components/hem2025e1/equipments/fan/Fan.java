 ...
 * invariant	{@code currentPowerLevel != null}
 * </pre>
			...
			FanInternalControlI
{
	...
	public static final Measure<Double>	LOW_POWER_IN_WATTS =
											new Measure<>(20.0, MeasurementUnit.WATTS);
	public static final Measure<Double>	HIGH_POWER_IN_WATTS =
											new Measure<>(60.0, MeasurementUnit.WATTS);
	public static final Measure<Double>	VOLTAGE =
											new Measure<>(220.0, MeasurementUnit.VOLTS);
	 ...
	 * post	{@code true}	// no postcondition.
	 * </pre>
	 * * @param fanUserInboundPortURI				URI of the inbound port to call the fan component for user interactions.
	 * @param fanInternalControlInboundPortURI	URI of the inbound port to call the fan component for internal control.
	 * @param fanExternalControlInboundPortURI	URI of the inbound port to call the fan component for external control.
	 * @throws Exception							<i>to do</i>.
	 */
	protected			Fan(
