...
// -----------------------------------------------------------------------------
/**
 * The class <code>VacuumCleanerSimpleUserModel</code> defines a very simple
 * user
...
public class VacuumCleanerSimpleUserModel
	 ...
	 * created.
	 */
	public static final String URI = VacuumCleanerSimpleUserModel.class.getSimpleName();
	...
	public VacuumCleanerSimpleUserModel(
		...
		assert VacuumCleanerSimpleUserModel.implementationInvariants(this) : new NeoSim4JavaException(
	 ...
	 * {@code SetLowVacuumCleaner} and {@code SwitchOffVacuumCleaner} in this order
