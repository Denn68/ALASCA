...
implements	WashingMachineEventI
{
	...
	protected final long	washingDuration;
	protected final double	targetTemperature;

	public				SetDelayedStart(
	...
	{
		// Prioritaire sur SwitchOff (on peut programmer juste avant d'éteindre ?)
		// Disons priorité standard.
		return true;
	}
	...
	public void			executeOn(AtomicModelI model)
	{
		...
		// On doit être allumé pour programmer un départ différé
		...
		wm.setDelayedStart(this.delay, this.washingDuration, this.targetTemperature);
	}
}