...
// -----------------------------------------------------------------------------
/**
 * The class <code>KettleElectricitySILModel</code> defines a simulation model
...
implements	SIL_KettleOperationI
{
	...
	public static final String	URI = KettleElectricitySILModel.class.getSimpleName();
	public static boolean		VERBOSE = true;
	public static boolean		DEBUG = false;

	protected static final double KEEP_WARM_POWER = 200.0;
	...
	protected static boolean	implementationInvariants(KettleElectricitySILModel instance)
	{
		...
		ret &= AssertionChecking.checkImplementationInvariant(
					...
					KettleElectricitySILModel.class, instance, "currentState != null");
		ret &= AssertionChecking.checkImplementationInvariant(
					instance.totalConsumption >= 0.0,
					KettleElectricitySILModel.class, instance, "totalConsumption >= 0.0");
		ret &= AssertionChecking.checkImplementationInvariant(
					instance.currentHeatingPower >= 0.0,
					KettleElectricitySILModel.class, instance, "currentHeatingPower >= 0.0");
		return ret;
	}
	...
	public static boolean	staticInvariants()
	{
		...
		ret &= AssertionChecking.checkStaticInvariant(
				...
				KettleElectricitySILModel.class, "URI != null && !URI.isEmpty()");
		return ret;
	}
		...
		) throws Exception
	{
		...
		assert	KettleElectricitySILModel.implementationInvariants(this);
		assert	KettleElectricitySILModel.invariants(this);
	}
	...
	public void			userDefinedInternalTransition(Duration elapsedTime)
	{
		...
		if (this.currentState == KettleState.ON) {
			...
			this.currentIntensity.setNewValue(this.currentHeatingPower / voltage, t);
	...
	public void userDefinedExternalTransition(Duration elapsedTime)
	{
		...
		this.totalConsumption +=
				Electricity.computeConsumption(
						elapsedTime,
						KettleExternalControlI.VOLTAGE.getData() *
