...
// -----------------------------------------------------------------------------
/**
 * The class <code>SetMediumVacuumCleaner</code> defines the simulation event of the
 * vacuum cleaner being set to medium mode.
 *
 ...
 * * @author	Team DeMoh
 */
public class			SetMediumVacuumCleaner
extends		AbstractVacuumCleanerEvent
{
	private static final long serialVersionUID = 1L;

	public				SetMediumVacuumCleaner(Time timeOfOccurrence)
	{
	...
	public void				executeOn(AtomicModelI model)
	{
		...
		if (m.getState() == VacuumCleanerState.ON) {
			if (m.getMode() != VacuumCleanerMode.MEDIUM) {
				m.setStateMode(VacuumCleanerState.ON, VacuumCleanerMode.MEDIUM);
