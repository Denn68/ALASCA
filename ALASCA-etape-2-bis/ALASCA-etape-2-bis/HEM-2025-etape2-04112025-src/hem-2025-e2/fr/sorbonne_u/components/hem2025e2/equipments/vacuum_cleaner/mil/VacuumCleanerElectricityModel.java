...
extends		AtomicHIOA
{
	...
	protected VacuumCleanerMode			currentMode = VacuumCleanerMode.MEDIUM;
		...
		) throws Exception
	{
		...
		this.lowModeConsumption = VacuumCleaner.LOW_POWER_IN_WATTS.getData();
		this.mediumModeConsumption = VacuumCleaner.MEDIUM_POWER_IN_WATTS.getData();
		this.highModeConsumption = VacuumCleaner.HIGH_POWER_IN_WATTS.getData();

		this.getSimulationEngine().setLogger(new StandardLogger());

		assert	VacuumCleanerElectricityModel.implementationInvariants(this) :
				new NeoSim4JavaException(
						"VacuumCleanerElectricityModel.implementationInvariants("
						+ "this)");
		assert	VacuumCleanerElectricityModel.invariants(this) :
				new NeoSim4JavaException(
			...
			switch (this.currentMode)
			{
				case LOW :
					this.currentIntensity.
						setNewValue(
							this.lowModeConsumption/VacuumCleaner.VOLTAGE.getData(),
							t);
					break;
				case MEDIUM :
					this.currentIntensity.
						setNewValue(
							this.mediumModeConsumption/VacuumCleaner.VOLTAGE.getData(),
							t);
					break;
				case HIGH :
					this.currentIntensity.
						setNewValue(
							this.highModeConsumption/VacuumCleaner.VOLTAGE.getData(),
							t);
			}
		} else {
