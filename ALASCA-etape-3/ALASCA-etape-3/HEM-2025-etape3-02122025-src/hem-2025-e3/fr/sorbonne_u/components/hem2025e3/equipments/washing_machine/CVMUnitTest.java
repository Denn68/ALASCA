...
extends AbstractCVM
{
	...
	public static Duration SIMULATION_DURATION =
			new Duration(2.0, SIMULATION_TIME_UNIT);
	/** Acceleration factor. */
...
//			ExecutionMode.STANDARD;
	...
	/**
	 * Create a test scenario without simulation.
	 */
	public static TestScenario unitTestScenario() throws VerboseException
	{
		...
		Instant startWashingInstant = startInstant.plusSeconds(300);
	...
	/**
	 * Create a test scenario with SIL simulation.
	 */
