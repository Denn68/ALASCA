...
/**
 * The class <code>WashingMachineTemperatureSILModel</code> defines a simulation
 * model for the water temperature inside a washing machine.
 *
 * <p><strong>Description</strong></p>
 *
 * <p>
 * The model simulates the water temperature evolution using a differential
 * equation based on the heating power provided by the electricity model.
 * When the target temperature is reached, it emits a HeatingFinished event
 * to synchronize with the electricity model.
 * </p>
 *
 * <ul>
 * <li>Imported events: StartWashing, SwitchOffWashingMachine, SuspendWashing,
 *     ResumeWashing, WashingEnded</li>
 * <li>Exported events: HeatingFinished</li>
 * <li>Imported variables: currentHeatingPower (from ElectricitySILModel)</li>
 * <li>Internal variables: currentWaterTemperature</li>
 * </ul>
 */
...
implements	SIL_WashingMachineOperationI
{
	...
	// Physical constants
	/** Initial water temperature (cold water from tap). */
	...
	/** Heating power imported from electricity model. */
	...
	/**
	 * Compute the derivative of the water temperature.
	 *
	 * @param current current water temperature
	...
	public void userDefinedInternalTransition(Duration elapsedTime)
	{
		...
		// Check if target temperature is reached during heating
		if (this.currentState == WashingMachineState.HEATINGWATER) {
			if (newTemp >= this.targetTemperature - TEMPERATURE_TOLERANCE) {
				...
				// Note: State will change to WASHING when ElectricitySILModel receives HeatingFinished
			}
		}
